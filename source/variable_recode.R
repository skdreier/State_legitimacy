...
data$courts_right <- func.recode(data$Q42A) # Q42A Courts: right to make binding decisions
data$police_right <- func.recode(data$Q42B) # Q42B Police: right to make people obey law
data$taxes_right <- func.recode(data$Q42C) # Q42C Tax authorities: right to make people pay taxes
